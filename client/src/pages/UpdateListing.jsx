            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
                <div className="flex flex-col gap-4 flex-1">
                    ...
                    <div className="flex flex-wrap gap-6">
                        ...
                        <div className="flex items-center gap-2">
                            <input type="number" className="p-3 border border-gray-300 rounded-lg" id='regularPrice' min='50' max='1000000' required onChange={handleChange} value={formData.regularPrice}/>
                        ...
                        {formData.offer && (
                            <div className="flex items-center gap-2">
                            <input type="number" className="p-3 border border-gray-300 rounded-lg" id='discountPrice' min='0' max='1000000' required onChange={handleChange} value={formData.discountPrice}/>
                            <div className="flex flex-col items-center">
                            <p>Discount price</p>
                            <span className="text-xs">($ / Month)</span>
                            </div>
