  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <Link to={"/create-listing"} className='bg-green-700 text-white p-3 rounded-lg uppercase text-center hover:opacity-95 disabled:opacity-80'>
          Create Listing
        </Link>
      </form>
      ...
      <button onClick={handleShowListings} className='text-green-700 w-full p-3 uppercase border rounded-lg'>Show listings</button>
      ...
      <div className='flex flex-col gap-4'>
        ...
        <div key={listing._id} className='border rounded-lg p-3 flex justify-between items-center gap-4'>
          ...
          <img src={listing.imageUrls} alt="listing image" className='h-16 w-16 object-contain' />
          </Link>
